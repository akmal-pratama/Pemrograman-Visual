...
Partial Class edit_cabang
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(edit_cabang))
        Button1 = New Button()
        txtNamaCabang = New TextBox()
        Label4 = New Label()
        ...
        Button1.Location = New Point(32, 984)
        Button1.Margin = New Padding(3, 4, 3, 4)
        Button1.Name = "Button1"
        Button1.Size = New Size(373, 51)
        Button1.TabIndex = 56
        Button1.Text = "Update cabang"
        Button1.UseVisualStyleBackColor = False
        ' 
        ' txtNamaCabang
        ' 
        txtNamaCabang.Font = New Font("Calibri", 11.25F)
        txtNamaCabang.ForeColor = Color.FromArgb(CByte(76), CByte(61), CByte(25))
        txtNamaCabang.Location = New Point(32, 212)
        txtNamaCabang.Margin = New Padding(3, 4, 3, 4)
        txtNamaCabang.Name = "txtNamaCabang"
        txtNamaCabang.Size = New Size(372, 30)
        txtNamaCabang.TabIndex = 55
        ' 
        ' Label4
        ' 
        ...
        Button2.Location = New Point(15, 24)
