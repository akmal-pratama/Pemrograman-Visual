...
Partial Class tambah_barber
    ...
    Private Sub InitializeComponent()
        ...
        TextBox2.Location = New Point(30, 392)
        ...
        Label3.Location = New Point(30, 368)
        Label3.Name = "Label3"
