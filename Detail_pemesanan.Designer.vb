...
Partial Class Detail_pemesanan
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Detail_pemesanan))
        Label9 = New Label()
        ...
        Label9.Location = New Point(33, 711)
        Label9.Name = "Label9"
        ...
        Label11.Location = New Point(33, 797)
        ...
        Label6.Location = New Point(33, 453)
        Label6.Name = "Label6"
        ...
        Label7.Location = New Point(33, 625)
        Label7.Name = "Label7"
        ...
        Label5.Location = New Point(33, 283)
        Label5.Name = "Label5"
        ...
        Label2.Name = "Label2"
        Label2.Size = New Size(302, 41)
        Label2.TabIndex = 48
        Label2.Text = "DETAIL PEMESANAN"
        ' 
        ' Button2
        ' 
        ...
        Button2.Location = New Point(23, 28)
        ...
        ' txtPaket
        ' 
        txtPaket.Font = New Font("Calibri", 11.25F)
        txtPaket.ForeColor = Color.FromArgb(CByte(76), CByte(61), CByte(25))
        txtPaket.Location = New Point(33, 738)
        txtPaket.Margin = New Padding(3, 4, 3, 4)
        txtPaket.Name = "txtPaket"
        txtPaket.ReadOnly = True
        txtPaket.Size = New Size(372, 30)
        txtPaket.TabIndex = 65
        ' 
        ' printDoc
        ' 
        ' 
        ' btnPrint
        ' 
        btnPrint.BackColor = Color.FromArgb(CByte(53), CByte(64), CByte(36))
        btnPrint.Font = New Font("Calibri", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnPrint.ForeColor = SystemColors.ButtonFace
        btnPrint.Location = New Point(33, 955)
        btnPrint.Name = "btnPrint"
        btnPrint.Size = New Size(372, 53)
        btnPrint.TabIndex = 66
        btnPrint.Text = "Cetak"
